Feature: Subscriber management
  ...
  Scenario: Creating a new subscriber should return the subscription object.
    ...
    And the subscription in the last response should have the type "EMAIL" and the value "test3@example.com",
  ...
  Scenario: Fetching a created subscription should return a subscription object.
    Given I created a subscriber with the type "EMAIL" and the value "test4@example.com"
  ...
  Scenario: Confirming a subscription should yield in a subscription being confirmed.
    Given I created a subscriber with the type "EMAIL" and the value "test5@example.com"
